...
for i in range(n//nch//npp):
    for j in range(nch):
        for k in range(npp):
            ...
            #------Канальные электронные ключи--------#
            if j == 0:
                mch_1_1[indx] = tgrp_123[indx]
                mch_2_1[indx] = tgrp_456[indx]
            elif j == 1:
                mch_1_2[indx] = tgrp_123[indx]
                mch_2_2[indx] = tgrp_456[indx]
            elif j == 2:
                mch_1_3[indx] = tgrp_123[indx]
                mch_2_3[indx] = tgrp_456[indx]
            # ----------------------------------------#
#--------------------------------------------------------------------------------------------------------#
...
# -------------2 система------------------#
final_sig_4 = filter(time, mch_2_1, 0.3, 4).real
final_sig_5 = filter(time, mch_2_2, 0.3, 4).real
final_sig_6 = filter(time, mch_2_3, 0.3, 4).real
# ----------------------------------------#
#--------------------------------------------------------------------------------------------------------#
